...
if(NOT DEFINED X_CPACK_RESOURCE_DIR OR "${X_CPACK_RESOURCE_DIR}" STREQUAL "")
    set(X_CPACK_RESOURCE_DIR "${PROJECT_SOURCE_DIR}/../res")
endif()

get_filename_component(X_CPACK_RESOURCE_DIR "${X_CPACK_RESOURCE_DIR}" ABSOLUTE BASE_DIR "${CMAKE_CURRENT_BINARY_DIR}")
file(MAKE_DIRECTORY "${X_CPACK_RESOURCE_DIR}")

configure_file("${PROJECT_SOURCE_DIR}/../LICENSE" "${X_CPACK_RESOURCE_DIR}/license.txt" @ONLY)

if(NOT EXISTS "${X_CPACK_RESOURCE_DIR}/readme.txt")
    configure_file("${PROJECT_SOURCE_DIR}/../README.md" "${X_CPACK_RESOURCE_DIR}/readme.txt" @ONLY)
endif()

set(CPACK_INCLUDE_TOPLEVEL_DIRECTORY OFF)
set(CPACK_OUTPUT_FILE_PREFIX packages)
set(CPACK_RESOURCE_FILE_LICENSE "${X_CPACK_RESOURCE_DIR}/license.txt")
set(CPACK_RESOURCE_FILE_README "${X_CPACK_RESOURCE_DIR}/readme.txt")
